...
`,
	"schema_version_29": `alter table feeds add column rtl boolean default 'f';
`,
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_29": "7cc7d5fe82da4d4820972b200d377b7d44011b150e315d4e3d242d84ad855e30",
